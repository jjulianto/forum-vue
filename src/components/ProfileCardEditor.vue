    ...
    <div class="profile-card">
        <VeeForm @submit="save">
            <p class="text-center avatar-edit">
                <label for="avatar">
                    <AppAvatarImg :src="activeUser.avatar" :alt="`${user.name} profile picture`"
            ...
            <ProfileCardEditorRandomAvatar @hit="activeUser.avatar = $event" />
...
import ProfileCardEditorRandomAvatar from './ProfileCardEditorRandomAvatar'

export default {
    components: { ProfileCardEditorRandomAvatar },
    props: {
        user: {
            type: Object,
            required: true

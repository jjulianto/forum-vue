    ...
    <div class="post-list">
        <div class="post" v-for="post in posts" :key="post.id">
            ...
            <div class="post-content">
                ...
                <a v-if="post.userId === $store.state.auth.authId" @click.prevent="toggleEditMode(post.id)" href="#"
                    style="margin-left: auto; padding-left:10px;" class="link-unstyled" title="Make a change">
                    <fa icon="pencil-alt" />
                </a>
            </div>
